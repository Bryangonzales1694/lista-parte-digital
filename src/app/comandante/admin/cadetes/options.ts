export const GRADO_OPTIONS = [
  { value: "4to_anio", label: "4to Año (C4)" },
  { value: "3er_anio", label: "3er Año (C3)" },
  { value: "2do_anio", label: "2do Año (C2)" },
  { value: "1er_anio", label: "1er Año (C1)" },
  { value: "aspirante", label: "Aspirante (ASP)" },
];
...
export const COMPANIA_OPTIONS = [
  ...
  { value: "CUARTA COMPAÑIA", label: "Cuarta Compañía" },
];
